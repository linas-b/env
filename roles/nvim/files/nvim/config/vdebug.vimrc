...
" source $HOME/.config/nvim/config/vdebug/iks_core.vimrc
"source $HOME/.config/nvim/config/vdebug/sensus_core.vimrc
" source $HOME/.config/nvim/config/vdebug/sensus_rostering.vimrc
